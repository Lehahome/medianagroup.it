...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<script src="<?php echo ASSETS_URL; ?>/js/romir.js"></script>
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <a href="/"><img src="<?php echo ASSETS_URL; ?>/img/logo.png" alt="SmartAdmin"></a></span>
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/login.php" title="Sign Out" data-action="userLogout" data-logout-msg="Вы уверены что хотите выйти?"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
				...
				<div id="shortcut">
					<ul>
						...
						<li>
							<a href="<?php echo APP_URL; ?>/romir_profile.php" class="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>Мой профиль</span> </span> </a>
						</li>
					</ul>
				</div>
				<!-- END SHORTCUT AREA -->

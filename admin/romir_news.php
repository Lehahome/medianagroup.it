		...
		<section id="widget-grid" class="">
			...
			<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<a onclick="window.location.href='<?=APP_URL?>/romir_add_new.php'" class="btn btn-info btn-lg" style="margin-bottom:20px;">Добавить новость</a>
 ...
 //   var zipEditParams = $.extend(true, {}, editParams, {url: 'ajax.php'});
		...
		jQuery("#jqgrid").jqGrid({
			...
			onSelectRow: function(id){    
				href="<?=APP_URL?>/romir_edit_new.php?id="+id;
				
			     //window.location.href="<?=APP_URL?>/romir_edit_new.php?id="+id;

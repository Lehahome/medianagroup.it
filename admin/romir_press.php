		...
		<section id="widget-grid" class="">
			...
			<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<a onclick="window.location.href='<?=APP_URL?>/romir_add_press.php'" class="btn btn-info btn-lg" style="margin-bottom:20px;">Добавить пресс релиз</a>
 ...
 //   var zipEditParams = $.extend(true, {}, editParams, {url: 'ajax.php'});
		...
		jQuery("#jqgrid").jqGrid({
			...
			onSelectRow: function(id){    
				  //window.location.href="<?=APP_URL?>/romir_edit_press.php?id="+id;	
				  href="<?=APP_URL?>/romir_edit_press.php?id="+id;
